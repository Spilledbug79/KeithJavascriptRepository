...
//     clearInterval(num)
//     sixes.push(random)
//     document.getElementById('d6-rolls-mean').innerText = findMean(sixes)
//     document.getElementById('d6-rolls-median').innerText = findMedian(sixes)
//     document.getElementById('d6-rolls-mode').innerText = findMode(sixes)
//   }
//   },30)
// })
...
//  document.querySelector('#double-d6-rolls-meadian').innerText = 'NA'
...
//   let sortedArr = sortByNumber(diceArr.slice())
...
// //   if(countObj[key] > mostRolls){
// //     mostRolls = countObj[key];
// //     mode = [key]
// //   }else if(countObj[key] === mostRolls){
// //     mode.push(key)
// //   }
// // }
// //   console.log(countObj, mostRolls)
// //   return mode
