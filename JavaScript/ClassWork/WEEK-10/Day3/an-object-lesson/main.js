...
myself.firstName = 'Keith';


// Add a `lastName` property and set it to a string.

myself.lastName = 'Eatherly';
...
myself.address.push("518");
myself.address.push("Hedrick St");
myself.address.push("Morristown, TN");
console.log(myself)
...
const favoriteFood = {
  foodName: "pizza",
  isFavorite: true,
  otherFavorites: [ "spaghetti", "hamburgers", "tacos"]
}
...
favoriteFood['most disliked food'] = 'Sauerkraut';
